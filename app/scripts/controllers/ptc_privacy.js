...
/**
 * @ngdoc function
 * @name razsapps.controller:PtcPrivacyPolicy
 * @description
 * # PtcPrivacyPolicy
 * Controller of the razsapps
 */
angular.module('razsapps')
  .controller('PtcPrivacyPolicy', function ($scope) {
    ...
    $scope.policies = [
        {
            header: 'Location',
            content: [
                'We may collect your geographical location.'
            ]
        },
        {
            header: 'Retention',
        ...
        },
        {
            ...
            content: [
                ...
                'We use the following companies for ads or analytics: AdMob, Millennial Media, and Flurry. You may visit their pages to see their privacy policies and opt-out.'
            ]
        },
        {
            header: 'Security',
        ...
        },
        {
            header: 'Updates',
            content: [
                'This privacy policy was last updated on 9/24/2013. Our privacy policy may change from time to time. If we make any material changes to our policies, we will place a prominent notice on our website or application.'
            ]
        },
        {
            header: 'Consent',
